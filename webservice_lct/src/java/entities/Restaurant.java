...
@NamedQueries({
    @NamedQuery(name = "Restaurant.findById", query = "SELECT e FROM Restaurant e WHERE e.id = :id"),
    @NamedQuery(name = "Restaurant.findByAdresse", query = "SELECT e FROM Restaurant e WHERE e.adresse = :adresse")})
